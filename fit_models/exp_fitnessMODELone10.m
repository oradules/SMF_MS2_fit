function ee=exp_fitnessMODEL10(k,alpha, x, s, ppno,pphi,ifile) 
 lambda1=k(1); 
 lambda2=k(2); 
 lambda3=k(3); 
 lambda4=k(4); 
 ...
 LL3 = - k1*k3*k5 - k1*k3*k9 - k1*k3*k10 - k1*k4*k9 - k1*k4*k10 - k1*k5*k9 - k2*k4*k9 - k1*k5*k10 - k2*k4*k10 - k2*k5*k9 - k2*k5*k10 - k3*k5*k9 - k3*k5*k10; 
 LL4 = k1*k3*k5*k10; 
 SS2 = -k5*k10; 
 SS3 = -k5*k10*(L1 + k1 + k2 + k3); 
 pt=k1*k3*k5 + k1*k3*k9 + k1*k3*k10 + k1*k4*k9 + k1*k4*k10 + k1*k5*k9 + k2*k4*k9 + k2*k4*k10 + k2*k5*k9 + k3*k5*k9; 
 p1= k2*k4*k9 + k2*k4*k10 + k2*k5*k9 + k3*k5*k9/pt; 
