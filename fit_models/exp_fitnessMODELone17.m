function ee=exp_fitnessMODEL17(k,alpha, x, s, ppno,pphi,ifile) 
 lambda1=k(1); 
 lambda2=k(2); 
 lambda3=k(3); 
 lambda4=k(4); 
 ...
 pt=k1*k3*k5*k6 + k1*k3*k5*k7 + k1*k3*k7*k8 + k1*k4*k7*k8 + k1*k3*k7*k10 + k2*k4*k7*k8 + k1*k4*k7*k10 + k2*k4*k7*k10; 
 p1= k2*k4*k7*(k8 + k10)/pt; 
 p2= k1*k4*k7*(k8 + k10)/pt; 
 p3= k1*k3*k7*(k8 + k10)/pt; 
 p4= k1*k3*k5*k6/pt; 
 p5= k1*k3*k5*k7/pt; 
