...
%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% fits the MODELS 9,10,11  using the functions exp_fitnessMODELXmergeoneponkini.m
...
%%%% MODEL DEPENDENT
DataFilePath0 = ['results_tat_MODEL',num2str(imodel),'_',num2str(100*alpha),'par_merge_onemovieponkini']; %%%% where to write results
...
%for MC=1:iter
    ...
    lf1 =  log(fmin)+log(fmax/fmin)*rand(1,9);
    k0(15:23)=k0(15:23).*exp(lf1); %%% ks 

switch imodel
    case 9, fobj=@(k)exp_fitnessMODEL9mergeoneponkini(k, alpha, xno, sno, xhi, shi, ppvalno,ppvalhi,kinino,kinihi);
    case 10, fobj=@(k)exp_fitnessMODEL10mergeoneponkini(k, alpha, xno, sno, xhi, shi, ppvalno,ppvalhi,kinino,kinihi);
    case 11, fobj=@(k)exp_fitnessMODEL11mergeoneponkini(k, alpha,   xno, sno, xhi, shi, ppvalno,ppvalhi,kinino,kinihi);
 end
...
if ~isinf(sobj) && ~isnan(sobj)
    ...
    10,10,10, ...
     0,0,0,0,...
     10,10,10,...
     10,10,10,10,10,10,10,10,10],opts);
