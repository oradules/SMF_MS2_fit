function ee=exp_fitnessMODEL5(k,alpha, x, s, ppno,pphi,ifile) 
 lambda1=k(1); 
 lambda2=k(2); 
 lambda3=k(3); 
 lambda4=k(4); 
 ...
 pt=k1*k3*k5*k6 + k1*k3*k5*k9 + k1*k3*k6*k9 + k1*k4*k6*k9 + k1*k3*k8*k9 + k1*k5*k6*k9 + k2*k4*k6*k9 + k1*k4*k8*k9 + k2*k5*k6*k9 + k1*k3*k9*k10 + k2*k4*k8*k9 + k3*k5*k6*k9 + k1*k4*k9*k10 + k2*k4*k9*k10; 
 p1= k9*(k2*k4*k6 + k2*k5*k6 + k2*k4*k8 + k3*k5*k6 + k2*k4*k10)/pt; 
 p2= k1*k9*(k4*k6 + k5*k6 + k4*k8 + k4*k10)/pt; 
 p3= k1*k3*k9*(k6 + k8 + k10)/pt; 
 p4= k1*k3*k5*k6/pt; 
 p5= k1*k3*k5*k9/pt; 
