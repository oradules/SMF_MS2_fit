...
%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% fits the MODELS 15,16  using the functions exp_fitnessMODELXmergeoneponkini.m
...
%for MC=1:iter
    ...
    k0(15:25)=k0(15:25).*exp(lf1); %%% ks 

switch imodel
    case 15, fobj=@(k)exp_fitnessMODEL15mergeoneponkini(k, alpha, xno, sno, xhi, shi, ppvalno,ppvalhi,kinino,kinihi);
    case 16, fobj=@(k)exp_fitnessMODEL16mergeoneponkini(k, alpha, xno, sno, xhi, shi, ppvalno,ppvalhi,kinino,kinihi);
end
