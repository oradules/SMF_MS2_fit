...
%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% fits the MODELS 4,5  using the functions exp_fitnessMODELXmergeonekini_mergep4p5ponkinishort.m
...
if imodel == 4    
    fobj=@(k)exp_fitnessMODEL4mergeonekini_mergep4p5ponkinishort(k, alpha, xno, sno, xhi, shi,  ppvalno,ppvalhi,kinino,kinihi);
else
    fobj=@(k)exp_fitnessMODEL5mergeonekini_mergep4p5ponkinishort(k, alpha, xno, sno, xhi, shi,  ppvalno,ppvalhi,kinino,kinihi);
end
