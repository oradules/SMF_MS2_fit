...
%%%%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% fits the MODELS 1  using the functions exp_fitnessMODELXmergeonekini_mergep4p5ponkinishort.m
...
%%%%%%%%%%%%%%%  A1no,A2no,A3no,A4no,A1hi,A2hi,A3hi,A4hi,k1,k2,k3,k4,k5,k6no,k7no,k8no,k6hi,k7hi,k8hi
%%%%%%%%%%%%%%%   
...
%for MC=1:iter
    ...
    %%%%% changed!
    fobj=@(k)exp_fitnessMODEL1mergeonekini_mergep4p5ponkinishort(k, alpha, xno, sno, xhi, shi,ppvalno,ppvalhi,kinino,kinihi); 
...
num2str(k7no,precision),', ',num2str(k8no,precision),', ', ...
num2str(k6hi,precision),', ',...
num2str(k7hi,precision),', ',num2str(k8hi,precision)];
fprintf(fid,'%s \n ',str);
else
